...
public class Loader extends Application {
    ...
    public VBox generateFSMControls() {
        ...
        newState.setOnAction((ActionEvent e) -> { dialogGenerator.createNewState(false); }); 
        /*
        ...
        */
        ...
        link.setOnAction((ActionEvent e) -> { dialogGenerator.createNewLink(); });
        ...
        newProject.setOnAction((ActionEvent e) -> { menu.newProject(); }); 
        
        Button loadProject = new Button("Import Project");
        loadProject.setOnAction((ActionEvent e) -> { menu.loadProject(); }); 
